		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#projetonetflix-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"projetonetflix-display": {
								"semanticObject": "projetonetflix",
								"action": "display",
								"description": "Jornada programador ABAP do 0",
								"title": "Projeto Netflix",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=projetonetflix",
									"url": sap.ui.require.toUrl("projetonetflix")
								}
							}
						}
					}
